import 'package:dhs_app/controllers/flight/airline_controller.dart';
import 'package:dhs_app/models/flight_model.dart';
import 'package:dhs_app/widgets/custom_image.dart';
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Row(
                                ...
                                children: [
                                  // Delay minutes (only when there is a delay)
                                  if ((flight.isDeparture &&
                                  ...
                                  // Unread badge — always shown when there are
                                  // unread messages, independent of any delay.
                                  unreadCount == 0
                                      ? SizedBox(width: 2.5.w)
                                      : Container(
