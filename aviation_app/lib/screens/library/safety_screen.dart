...
class SafetyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Load safety documents when screen opens
    controller.loadSafetyDocuments();
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          final documents = controller.safetyDocuments;
                      ...
                      searchQuery.value.isEmpty
                          ...
                          : allItems.where((item) {
                            return item.name.toLowerCase().contains(
                                ...
                                (item.editionNumber?.toLowerCase().contains(
                                      searchQuery.value,
                                    ) ??
                                    false);
                          }).toList();
