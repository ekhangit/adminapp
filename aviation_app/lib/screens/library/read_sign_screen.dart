...
class ReadSignScreen extends StatelessWidget {
  const ReadSignScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    // Load all read and sign documents when screen opens
    controller.loadAllReadAndSign();
